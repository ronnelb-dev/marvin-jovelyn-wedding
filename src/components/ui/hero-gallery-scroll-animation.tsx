...
const BentoCell = React.forwardRef<HTMLDivElement, BentoCellProps>(
  (
    ...
    const x = useTransform(scrollYProgress, [0.08, 0.72], [fromX, "0vw"])
    const y = useTransform(scrollYProgress, [0.08, 0.72], [fromY, "0vh"])
    const scale = useTransform(scrollYProgress, [0, 0.78], [fromScale, 1])
