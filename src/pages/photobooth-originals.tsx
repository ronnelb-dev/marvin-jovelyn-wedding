        ...
        <AnimatePresence mode="wait" custom={direction}>
          ...
          >
            <img
              ...
              alt={`Photobooth moment ${currentIndex + 1}`}
...
export async function getStaticProps() {
  try {
    ...
    // Fetch all images from the photobooth originals folder
    const results = await cloudinaryyyy.search
      .expression('folder:PhotoboothOriginals')
...
export default function PhotoboothGalleryPage({
  images,
}: {
  images: GalleryImage[];
}) {
  ...
  return (
    <>
      <Head>
        <title>Marvin & Jovelyn - Photobooth Originals Gallery</title>
        <meta name="description" content="Photobooth Originals - A beautiful collection of our special moment" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />
        <meta property="og:title" content="Marvin & Jovelyn - Photobooth Originals Gallery" />
        <meta property="og:description" content="Photobooth Originals Gallery" />
        ...
        <section className="py-16 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4 mt-4">Photobooth Originals Moments</h2>
