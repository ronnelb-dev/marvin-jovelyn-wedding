...
export async function getStaticProps() {
  try {
    ...
    // Fetch all images from the photobooth prints folder
    const results = await cloudinaryyyy.search
      .expression('folder:PhotoboothPrints')
...
export default function PhotoboothGalleryPage({
  ...
  return (
    <>
      <Head>
        <title>Marvin & Jovelyn - Photobooth Prints Gallery</title>
        <meta name="description" content="Photobooth Prints - A beautiful collection of our special moment" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />
        <meta property="og:title" content="Marvin & Jovelyn - Photobooth Prints Gallery" />
        <meta property="og:description" content="Photobooth Prints Gallery" />
        ...
        <section className="py-16 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4 mt-4">Photobooth Prints Moments</h2>
